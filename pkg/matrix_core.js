/* @ts-self-types="./matrix_core.d.ts" */
...
export class Game {
     ...
     */
    blocks_ptr() {
        const ret = wasm.game_blocks_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    enemies_ptr() {
        const ret = wasm.game_enemies_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     ...
     */
    fire() {
        const ret = wasm.game_fire(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    max_particles() {
        const ret = wasm.game_max_particles(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} seed
     ...
     */
    particle_count() {
        const ret = wasm.game_particle_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    particles_ptr() {
        const ret = wasm.game_particles_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    rain_len() {
        const ret = wasm.game_rain_len(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    rain_ptr() {
        const ret = wasm.game_rain_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    shot_ptr() {
        const ret = wasm.game_shot_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    state_ptr() {
        const ret = wasm.game_state_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     * @returns {number}
     */
    step(dt, fwd, right, sprint) {
        const ret = wasm.game_step(this.__wbg_ptr, dt, fwd, right, sprint);
        return ret >>> 0;
    }
    /**
     * @returns {number}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('matrix_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
