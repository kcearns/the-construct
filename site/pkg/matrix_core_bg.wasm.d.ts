...
export const game_particles_ptr: (a: number) => number;
export const game_rain_len: (a: number) => number;
export const game_rain_ptr: (a: number) => number;
export const game_reset: (a: number) => void;
export const game_shot_ptr: (a: number) => number;
export const game_state_ptr: (a: number) => number;
export const game_step: (a: number, b: number, c: number, d: number, e: number) => number;
